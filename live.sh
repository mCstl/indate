...
#apt install python3-lxml python3-lxml-dbg -y
#apt install npm -y
#apt install libxml2 libxml2-dev libxslt1.1 libxslt1-dev -y
#apt install wine32 winbind
#echo
...
#mkdir git
#cd git
#git clone https://github.com/m4ll0k/DeepSearch.git
